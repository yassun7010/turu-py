...
class TestTuruPostgresMock:
    ...
    def test_execute_with_tag(self, mock_connection: turu.postgres.MockConnection):
        @dataclass
        class Table:
            pass
    ...
    def test_executemany_with_tag(self, mock_connection: turu.postgres.MockConnection):
        @dataclass
        class Table:
            pass
