...
class TestTuruSnowflake:
    ...
    def test_execute_map_named_tuple_type(self, connection: Connection):
        class Row(NamedTuple):
            pass
    ...
    def test_execute_map_dataclass_type(self, connection: Connection):
    ...
    def test_execute_map_pandas_type(self, connection: Connection):
    ...
    def test_execute_pyarrow_type(self, connection: Connection):
    ...
    def test_connection_timeout(self, connection: Connection):
        with connection.execute_map(Row, "select 1", timeout=10) as cursor:
            assert cursor.fetchone() == Row(1)

    def test_connection_num_statements(self, connection: Connection):
    ...
    def test_cursor_timeout(self, connection: Connection):
        with connection.cursor().execute_map(Row, "select 1", timeout=10) as cursor:
            assert cursor.fetchone() == Row(1)

    def test_cursor_num_statements(self, connection: Connection):
    ...
    def test_fetch_arrow_all(self, connection: Connection):
    ...
    @pytest.mark.skipif(not USE_PYARROW, reason="pyarrow is not installed")
    def test_fetch_arrow_batches(self, connection: Connection):
    ...
    @pytest.mark.skipif(not USE_PANDAS, reason="pandas is not installed")
    def test_record_pandas_dataframe(self, connection: Connection):
        import pandas as pd  # type: ignore[import]
        from pandas.testing import assert_frame_equal  # type: ignore[import]
    ...
    @pytest.mark.skipif(not USE_PANDAS, reason="pandas is not installed")
    def test_record_pandas_dataframe_with_limit_option(self, connection: Connection):
        import pandas as pd  # type: ignore[import]
        from pandas.testing import assert_frame_equal  # type: ignore[import]
    ...
    def test_fetch_pandas_all_using_pandera_model(self, connection: Connection):
        import pandera as pa  # type: ignore[import]
