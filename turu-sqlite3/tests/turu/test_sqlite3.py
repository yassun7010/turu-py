...
from turu.sqlite3 import Connection
...
class TestTuruSqlite3:
    ...
    def test_execute_fetchmany(self, connection: Connection):
    ...
    def test_execute_fetchmany_with_size(self, connection: Connection):
    ...
    def test_execute_fetchall(self, connection: Connection):
        cursor = connection.cursor().execute("select 1")
    ...
    def test_execute_map(self, connection: Connection):
    ...
    def test_cursor_close(self, connection: Connection):
    ...
    def test_recording_and_testing(
        ...
        def do_something(connection: Connection):
            with record_to_csv(
