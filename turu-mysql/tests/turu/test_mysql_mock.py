...
class TestTuruMysqlMock:
    def test_execute(self, mock_connection: turu.mysql.MockConnection):
        expected = [(1,)]
        mock_connection.inject_response(None, expected)

        assert mock_connection.execute("select 1").fetchall() == expected

    def test_execute_fetchone(self, mock_connection: turu.mysql.MockConnection):
        expected = [(1,)]
        mock_connection.inject_response(None, expected)

        assert mock_connection.execute("select 1").fetchone() == expected[0]

    def test_execute_map_fetchone(self, mock_connection: turu.mysql.MockConnection):
        expected = [Row(id=1)]
    ...
    def test_execute_map_fetchmany(self, mock_connection: turu.mysql.MockConnection):
    ...
    def test_execute_map_fetchmany_with_size(
        self, mock_connection: turu.mysql.MockConnection
    ):
    ...
    def test_execute_map_fetchall(self, mock_connection: turu.mysql.MockConnection):
        expected = [Row(id=1), Row(id=2)]
    ...
    def test_executemany(self, mock_connection: turu.mysql.MockConnection):
        expected = [(1,)]
        mock_connection.inject_response(None, expected)
    ...
    def test_executemany_map(self, mock_connection: turu.mysql.MockConnection):
        expected = [Row(id=1), Row(id=2)]
        mock_connection.inject_response(Row, expected)
    ...
    def test_execute_iter(self, mock_connection: turu.mysql.MockConnection):
        expected = [(1,), (2,)]
        mock_connection.inject_response(None, expected)
    ...
    def test_execute_map_iter(self, mock_connection: turu.mysql.MockConnection):
        expected = [Row(id=1), Row(id=2)]
        mock_connection.inject_response(Row, expected)
        with mock_connection.cursor().execute_map(
            Row, "select 1 union all select 2"
    ...
    def test_mock_connection_close(self, mock_connection: turu.mysql.MockConnection):
        mock_connection.close()

    def test_mock_connection_commit(self, mock_connection: turu.mysql.MockConnection):
        mock_connection.commit()

    def test_mock_connection_rollback(self, mock_connection: turu.mysql.MockConnection):
        mock_connection.rollback()

    def test_cursor_rowcount(self, mock_connection: turu.mysql.MockConnection):
        cursor = mock_connection.cursor()
        assert cursor.rowcount == -1

    def test_cursor_arraysize(self, mock_connection: turu.mysql.MockConnection):
        cursor = mock_connection.cursor()
        assert cursor.arraysize == 1

    def test_cursor_arraysize_setter(self, mock_connection: turu.mysql.MockConnection):
        cursor = mock_connection.cursor()
        cursor.arraysize = 2
        assert cursor.arraysize == 2

    def test_execute_with_tag(self, mock_connection: turu.mysql.MockConnection):
        @dataclass
        class Table:
            pass
    ...
    def test_executemany_with_tag(self, mock_connection: turu.mysql.MockConnection):
        @dataclass
        class Table:
            pass
